...
public class HexMapCamera : MonoBehaviour
{
	...
	{
		if (stick == null || swivel == null) { throw new System.Exception(); }
		zoom = Mathf.Clamp01(zoom + delta);

		float distace = Mathf.Lerp(stickMinZoom, stickMaxZoom, zoom);
		stick.localPosition = new Vector3(0f, 0f, distace);
	...
	{
		if (grid == null) { throw new System.Exception(); }
		float xMax =
