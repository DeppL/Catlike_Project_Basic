...
public class HexMesh : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		meshCollider = gameObject.AddComponent<MeshCollider>() ?? throw new System.Exception();
		hexMesh.name = "Hex Mesh";
	}

	public void Triangulate(HexCell[] cells)
	{
		if (hexMesh == null) { throw new System.Exception(); }
		hexMesh.Clear();
		vertices.Clear();
		colors.Clear();
		triangles.Clear();
		...
		if (meshCollider is MeshCollider) meshCollider.sharedMesh = hexMesh;
	}
	...
	void TriangulateEdgeTerraces (
		...
		for (int i = 2; i < HexMetrics.terraceStep; i++)
		{
			var e1 = e2;
			var c1 = c2;
